...
function loadCustomerData() {
    setText('displayUrgencyMode', sessionStorage.getItem('urgencyMode') || 'عادي 🕐');
    var data = {
        name: sessionStorage.getItem('customerName') || 'غير معروف',
        mother: sessionStorage.getItem('customerMother') || 'غير معروف',
        nationalId: sessionStorage.getItem('customerNationalId') || 'غير معروف',
        regNo: sessionStorage.getItem('customerRegNo') || 'غير معروف',
        propNo: sessionStorage.getItem('customerPropNo') || 'غير معروف',
        location: sessionStorage.getItem('customerLocation') || 'غير معروف',
        serviceType: sessionStorage.getItem('serviceType') || 'بيان قيد',
        servicePrice: sessionStorage.getItem('servicePrice') || '...'
    };
